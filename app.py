...
def load_data():
    ...
    # Extract Month Name for the filter (e.g., "January")
...
# --- 3. MAIN DASHBOARD ---
# UPDATE 1: Added "(2024 Data)" to the main title
...
# UPDATE 2: Fixed logic to always show "2024" in the caption
if len(selected_months) == 12:
    period_text = "Full Year 2024"
else:
    # Appends "2024" to the list of months (e.g., "January, March 2024")
